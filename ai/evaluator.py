...
- 家賃: 手取り30万+補助2万。管理費込み11〜12万がベスト、13万以下がスイートスポット、13〜13.5万は減点ゾーン、13.5万が絶対上限（超えたらスコア0）
...
- 敷礼なし or 少額を好む
- 仲介手数料不要は大きなプラス
- 管理費込み11〜12万がベスト。13万以下ならスイートスポット。13〜13.5万は減点ゾーン。13.5万が絶対上限（超えたら入居不可＝スコア0）
...
- **11.0万〜13.0万**: +5点ボーナス（スイートスポット／理想値、ここに入れば強くおすすめしやすい）
